...
st.set_page_config(page_title="Nursery Training Audio Series", page_icon="🌱", layout="wide")

# Inject custom CSS + HTML site design
st.markdown("""
<style>
    body {
      margin: 0;
    ...
    .section { max-width: 1000px; margin: auto; padding: 4rem 2rem; }
    ...
    h2 { font-size: 2rem; margin-bottom: 1rem; color: #002b45; }

    audio { margin: 1.5rem 0; width: 100%; max-width: 650px; border-radius: 12px; }
